...
export function about(): string {
    return `
        <div class="about">
            ...
            I like also tinkering with back end technologies.
            </p>
            <blockquote>
                <p> “If you can't explain it simply you don't understand it well enough.”
                 &mdash; ${a(ContainerIds.Noop, 'https://skeptics.stackexchange.com/questions/8742/did-einstein-say-if-you-cant-explain-it-simply-you-dont-understand-it-well-en',
                 '<s>Albert Einstein</s>', '_blank')}</p>
            </blockquote>
            <p>
            ...
            ${a(ContainerIds.Noop, 'https://github.com/CanisMajorisLT/blog', 'custom static site generator', '_black')}.
            From the ground up it's
            progressively enhanced and can run on any browser, with or without javascript. </p>
        </div>
`;
}
